...
# data
dataset = 'openwebtext'
data_dir = r'/cephfs/shared/zhangyuxuan/openwebtext'
...
def log_weight_distribution(model, it, out_dir=out_dir, bins=120):
    import matplotlib
    matplotlib.use('Agg')
